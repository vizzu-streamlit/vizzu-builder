...
class App:
    ...
    def _add_intro(self) -> None:
        ...
        col4.image(
            "https://github.com/vizzuhq/vizzu-workshops/blob/main/2023-11-20-Budapest_BI_Forum/assets/Vizzu_Logo2.png?raw=true"
        )
        col1, col2 = st.columns(2)
        col1.markdown(
            """- Create stunning Vizzu charts and animated data stories without writing a single line of code.
...
- Access the Python code of the generated charts and fine-tune them in a notebook or another Streamlit app if needed."""
        ...
        col2.markdown(
            """- Learn to use our open-source Python tool, [ipyvizzu](https://ipyvizzu.com), via the code automatically generated for all charts and stories.
